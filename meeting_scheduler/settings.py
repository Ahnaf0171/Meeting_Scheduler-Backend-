...
SECRET_KEY = 'django-insecure-xr0d!p#45(5qw5f%7_)p==0+p6)%)du+njg*&%)_i&ty&%1nkc'
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "API documentation for the Meeting Scheduler backend (meetings, participants, ICS, notifications).",
    "VERSION": "1.0.0",
